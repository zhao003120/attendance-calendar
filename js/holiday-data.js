 ...
 *
 * 注意：以下数据基于2026年日历推算，实际安排以国务院办公厅
 * 发布的放假通知为准。如需调整，直接修改此文件即可。
 */
const HOLIDAY_DATA = {
  // ===== 元旦：1月1日(周四) =====
  // 放假：1月1日(四) ~ 1月3日(六)，共3天，无调休
  '2026-01-01': { type: 'holiday', name: '元旦' },
  '2026-01-02': { type: 'holiday', name: '元旦' },
  '2026-01-03': { type: 'holiday', name: '元旦' },

  // ===== 春节：2月17日(周二，正月初一) =====
  // 放假：2月15日(日) ~ 2月21日(六)，共7天
  // 调休上班：2月14日(六)、2月22日(日)
  ...
  '2026-02-22': { type: 'workmakeup', name: '春节调休上班' },
  ...
  // 调休上班：4月26日(日)、5月9日(六)
  '2026-04-26': { type: 'workmakeup', name: '劳动节调休上班' },
  ...
  // ===== 中秋节：9月25日(周五) =====
  // 放假：9月25日(五) ~ 9月27日(日)，共3天
  // 调休上班：9月20日(日)
  '2026-09-20': { type: 'workmakeup', name: '中秋节调休上班' },
  ...
  '2026-10-11': { type: 'workmakeup', name: '国庆调休上班' },
};

const HOLIDAY_SUMMARIES = [
  { name: '元旦',   dates: '1月1日~1月3日',   days: 3, makeup: '无' },
  { name: '春节',   dates: '2月15日~2月21日',  days: 7, makeup: '2月14日、2月22日' },
  { name: '清明节', dates: '4月4日~4月6日',    days: 3, makeup: '无' },
  { name: '劳动节', dates: '5月1日~5月5日',    days: 5, makeup: '4月26日、5月9日' },
  { name: '端午节', dates: '6月19日~6月21日',  days: 3, makeup: '无' },
  { name: '中秋节', dates: '9月25日~9月27日',  days: 3, makeup: '9月20日' },
  { name: '国庆节', dates: '10月1日~10月7日',  days: 7, makeup: '10月10日、10月11日' },
];
